...
import ancillaryJustice from './descriptions/ancillary-justice'

const sciFi = [
  {title: 'H.I.V.E.', author: 'Mark Walden', recommendationLevel: 3, slug: 'hive', isbn: '9780747583707', ageRating: {age: ageRatings.EARLY}},
  {title: 'Ancillary Justice', author: 'Ann Leckie', recommendationLevel: 2, slug: 'ancillary-justice', isbn: '9780316246620', ageRating: {age: ageRatings.ADULT, aimedAt: true}, description: ancillaryJustice},
